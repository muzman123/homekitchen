          ...
          <div className="flex border-b text-black">
            <button
              ...
              className={`flex-1 py-2 text-center ${
                activeTab === "menu" ? "border-b-2 border-green-600" : ""
              }`}
            >
              Menu Items
            </button>
            <button
              ...
              className={`flex-1 py-2 text-center ${
                activeTab === "meal" ? "border-b-2 border-green-600" : ""
              }`}
            >
              Meal Plans
            </button>
                          ...
                          {planItems[planId] ? (
                            <ul className="list-disc list-inside space-y-1">
                              {planItems[planId].map(item => (
                                <li key={item[0]}>
                                  <span className="font-semibold">{item[2]}</span> &mdash; {item[3]} ($
                                  {item[4].toFixed(2)})
                                </li>
                              ))}
                            </ul>
